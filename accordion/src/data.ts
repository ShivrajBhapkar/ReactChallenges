export const data = [
    {
        que: "Do I have to allow the use of cookies?",
    ...
    {
        que: "How do I change my My Page password?",
    ...
    {
        que: "Whose birth number can I use?",
    ...
    {
        que: "When do I recieve a password ordered by letter?",
